...
@section('content')
    <div class="container">
        ...
        <form method="post"action="{{url('ride_shares')}}"> 
            ...
            <div class="form-group">
                <label for="current_available_seats">Current Available Seats:</label>
                <input type="number" class="form-control" id="current_available_seats" name="current_available_seats" required>
            </div>
            <div class="form-group">
